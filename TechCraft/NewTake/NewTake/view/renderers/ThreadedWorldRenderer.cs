...
namespace NewTake.view.renderers
{
    public class ThreadedWorldRenderer : IRenderer
    {
        ...
        public const float FOGNEAR = 14 * 16;//(BUILD_RANGE - 1) * 16;
        ...
        private void DrawWater(GameTime gameTime)
        {
            ...
            _waterBlockEffect.Parameters["FogNear"].SetValue((float)FOGNEAR);
            _waterBlockEffect.Parameters["FogFar"].SetValue((float)FOGFAR);
